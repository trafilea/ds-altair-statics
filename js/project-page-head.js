...
function addDraft(new_angle_id, new_angle_name, new_benchmark_id, new_benchmark_name, new_draft_id) {
    ...
    console.log($('#benchmark_' + new_angle_id + '_' + new_benchmark_id + '_id'))
    console.log($('#benchmark_' + new_angle_id + '_' + new_benchmark_id + '_id').length)
    if ($('#benchmark_' + new_angle_id + '_' + new_benchmark_id + '_id').length == 0) {
